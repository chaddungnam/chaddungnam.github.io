...
const LOCALES = {
  kr: { lang: "ko", label: "한국어", back: "모든 포스트", heading: "제작 기록", hero: ["만드는 과정을", "포스트로 기록합니다."], heroNote: "게임과 소프트웨어를 만들며 겪은 실험, 실패, 수정과 출시 판단을 기록합니다.", games: "제작 중인 게임", release: "출시 준비 중", development: "개발 중", description: "게임과 앱을 만들며 겪은 시행착오와 출시 과정을 기록하는 House Duck 개발 블로그입니다.", skip: "본문으로 건너뛰기", theme: "색상 테마 전환", noteTitle: "공식 블로그", note: "같은 글을", original: "House Duck Blog에서 읽기", auto: false },
  en: { lang: "en", label: "English", back: "All posts", heading: "Build notes", hero: ["I record the making process", "one post at a time."], heroNote: "Experiments, mistakes, revisions, and release decisions from building games and software.", games: "Games in progress", release: "Preparing for release", development: "In development", description: "House Duck build notes about making games and apps, including real decisions, mistakes, and release work.", skip: "Skip to content", theme: "Switch color theme", noteTitle: "Automatic translation", note: "This page was automatically translated from Korean and may contain unnatural wording.", original: "Read the Korean original", auto: true },
  de: { lang: "de", label: "Deutsch", back: "Alle Beiträge", heading: "Entwicklungsnotizen", hero: ["Ich halte den Entstehungsprozess", "Beitrag für Beitrag fest."], heroNote: "Experimente, Fehler, Korrekturen und Veröffentlichungsentscheidungen aus der Entwicklung.", games: "Spiele in Entwicklung", release: "Veröffentlichung in Vorbereitung", development: "In Entwicklung", description: "Entwicklungsnotizen von House Duck über Spiele, Apps, Entscheidungen, Fehler und Veröffentlichungen.", skip: "Zum Inhalt springen", theme: "Farbschema wechseln", noteTitle: "Automatische Übersetzung", note: "Diese Seite wurde automatisch aus dem Koreanischen übersetzt und kann unnatürliche Formulierungen enthalten.", original: "Koreanisches Original lesen", auto: true },
  ja: { lang: "ja", label: "日本語", back: "すべての記事", heading: "開発記録", hero: ["作る過程を", "一つずつ記事に残します。"], heroNote: "ゲームやソフトウェア制作での実験、失敗、修正、リリース判断を記録します。", games: "制作中のゲーム", release: "リリース準備中", development: "開発中", description: "ゲームやアプリを作る中での判断、失敗、改善、リリース過程を記録するHouse Duckの開発ブログです。", skip: "本文へ移動", theme: "カラーテーマを切り替える", noteTitle: "自動翻訳", note: "このページは韓国語から自動翻訳されているため、不自然な表現が含まれる場合があります。", original: "韓国語の原文を読む", auto: true },
};
