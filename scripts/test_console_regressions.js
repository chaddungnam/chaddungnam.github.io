...
assert.match(consoleHtml, /analytics\.js\?v=20260829-11/, "the Console must cache-bust the updated analytics renderer");
...
assert.match(consoleHtml, /model\.js\?v=20260829-6/, "the Console must cache-bust the Korean analytics labels");
