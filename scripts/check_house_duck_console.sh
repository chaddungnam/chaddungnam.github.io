...
rg -q 'HEXAWORLD 1984' "$console_dir/index.html"
...
rg -F -q 'QA 기능·TestFlight·Google Play 테스트 결제를 제외한 운영 구매만' "$console_dir/index.html"
rg -F -q 'const purchaseExclusions = state.payload?.purchaseExclusions' "$console_dir/analytics.js"
