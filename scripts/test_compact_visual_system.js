...
assert.match(studio, /\.studio-intro\s*\{[^}]*align-items:\s*center[^}]*padding-block:\s*clamp\(40px,\s*5vw,\s*64px\)/s);
assert.match(studio, /\.studio-intro h1\s*\{[^}]*font-size:\s*clamp\(2\.25rem,\s*4vw,\s*3\.5rem\)/s);
