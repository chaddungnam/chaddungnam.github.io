...
- [ ] **Step 2: Create the minimal JavaScript**
...
- [ ] **Step 4: Keep changes for the localized page task**
...
- [ ] **Step 2: Rebuild `index_en.html` with structural parity**
...
- [ ] **Step 3: Run the contract and existing public checks**
...
- [ ] **Step 4: Commit the shared system and studio pages**
...
- [ ] **Step 1: Rebuild the Korean product page**
...
- [ ] **Step 2: Rebuild the English product page**
...
- [ ] **Step 4: Commit the product pages**
...
- [ ] **Step 2: Capture and inspect representative viewports**
